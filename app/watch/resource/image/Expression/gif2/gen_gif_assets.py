#!/usr/bin/env python3
"""
Convert gif2/*.gif files into C source files for embedding into firmware.
...
HEADER_FILE = os.path.join(OUT_DIR, "expression_gif2_assets.h")
...
HEADER_TEMPLATE = """\
/**
 * Expression GIF assets declarations (gif2).
