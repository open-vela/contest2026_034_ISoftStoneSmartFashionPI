...
/* MiSans-Regular used as bold variant since AlibabaPuHuiTi-3-95-ExtraBold
 * TTF is not embedded. Both fonts support Chinese (CJK) characters. */
#define BANDX_BOLD_FONT "MiSans-Regular"
#endif
