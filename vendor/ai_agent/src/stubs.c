...
/* Voice channel stubs removed — real implementations in voice_channel.c */
...
__attribute__((weak)) void media_recorder_close_socket(void* handle)
{
    (void)handle;
}
#endif
...
__attribute__((weak)) bool agent_is_running(void)
{
    return false;
}
