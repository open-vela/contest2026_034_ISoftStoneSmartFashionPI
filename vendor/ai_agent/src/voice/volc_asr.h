...
/* Non-blocking check: try to read a server response between sends.
 * Returns 1=final utterance (text_out filled), 0=no result yet, <0=error.
 * Server-side silence/VAD triggers final responses without client VAD. */
