...
static const char * const s_protected_files[] = {
    AGENT_CONFIG_FILE,   /* e.g. /mnt/spif/ai_agent/config/config.json */
    AGENT_SOUL_FILE,     /* e.g. /mnt/spif/ai_agent/config/SOUL.md     */
    AGENT_USER_FILE,     /* e.g. /mnt/spif/ai_agent/config/USER.md     */
    NULL
};
