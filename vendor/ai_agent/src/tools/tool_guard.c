...
static const tool_sec_entry_t s_sec_table[] = {
    ...
    { "play_audio",                 TOOL_SEC_MODERATE  },
    { "fall_protection_feedback",   TOOL_SEC_MODERATE  },
    { "trigger_mijia_scene",        TOOL_SEC_SENSITIVE },
#endif
};
...
static const char * const s_sensitive_names[SENSITIVE_TOOL_COUNT] = {
...
static const char * const s_redact_keys[] = {
...
static const char * const s_injection_patterns[] = {
    "ignore all previous",
