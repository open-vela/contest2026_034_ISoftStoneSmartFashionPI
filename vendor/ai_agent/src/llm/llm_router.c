...
static const char * const s_complex_keywords[] = {
...
static const char * const s_simple_keywords[] = {
...
static bool contains_keyword(const char* text, const char * const * keywords)
{
    if (!text || !keywords) {
        return false;
    }
