...
/** Returns true while the ai_agent task is alive (between ai_agent_main
 * entry and its final return).  Used by the launcher to wait for
 * teardown before re-launching the agent on runtime UI-mode switch. */
