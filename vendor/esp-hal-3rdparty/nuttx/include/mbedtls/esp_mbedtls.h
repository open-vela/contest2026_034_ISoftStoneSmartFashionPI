...
#  define mbedtls_base64_encode                     esp_mbedtls_base64_encode
#  define mbedtls_base64_decode                     esp_mbedtls_base64_decode
#  define mbedtls_net_init                          esp_mbedtls_net_init
#  define mbedtls_net_connect                       esp_mbedtls_net_connect
#  define mbedtls_net_send                          esp_mbedtls_net_send
#  define mbedtls_net_recv                          esp_mbedtls_net_recv
#  define mbedtls_net_free                          esp_mbedtls_net_free
#  define mbedtls_net_set_block                     esp_mbedtls_net_set_block
#  define mbedtls_net_set_nonblock                  esp_mbedtls_net_set_nonblock
#  define mbedtls_ssl_handshake                     esp_mbedtls_ssl_handshake
#  define mbedtls_ssl_close_notify                  esp_mbedtls_ssl_close_notify
#  define mbedtls_ssl_set_hostname                  esp_mbedtls_ssl_set_hostname
#  define mbedtls_ssl_conf_alpn_protocols           esp_mbedtls_ssl_conf_alpn_protocols
#  define mbedtls_ssl_conf_min_tls_version          esp_mbedtls_ssl_conf_min_tls_version
#  define mbedtls_ssl_conf_max_tls_version          esp_mbedtls_ssl_conf_max_tls_version
#  define mbedtls_sha1                              esp_mbedtls_sha1
#  define mbedtls_strerror                          esp_mbedtls_strerror
#endif
