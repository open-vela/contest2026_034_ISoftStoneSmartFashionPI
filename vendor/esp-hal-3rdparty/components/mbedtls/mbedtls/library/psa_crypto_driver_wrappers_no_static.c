 ...
 */
psa_status_t esp_psa_driver_wrapper_get_key_buffer_size(
...
psa_status_t esp_psa_driver_wrapper_export_public_key(
    const psa_key_attributes_t *attributes,
...

{
    ...
    switch( location )
    {
        case PSA_KEY_LOCATION_LOCAL_STORAGE:
            ...
            return( esp_psa_export_public_key_internal( attributes,
                                                    key_buffer,
                                                    key_buffer_size,
                                                    data,
                                                    data_size,
...
psa_status_t esp_psa_driver_wrapper_get_builtin_key(
