...
extern int (*esp_mbedtls_lmots_sign_private_key_invalidated_hook)(unsigned char *);
 ...
 */
int MBEDTLS_DEPRECATED esp_mbedtls_lms_error_from_psa(psa_status_t status);
#endif
 ...
 *                           esp_mbedtls_lmots_verify will be used for LMOTS
