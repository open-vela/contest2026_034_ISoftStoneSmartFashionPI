...
extern const mbedtls_cipher_definition_t esp_mbedtls_cipher_definitions[];

extern int esp_mbedtls_cipher_supported[];

extern const mbedtls_cipher_base_t *esp_mbedtls_cipher_base_lookup_table[];
