...
extern signed char esp_mbedtls_aesce_has_support_result;
...
#define MBEDTLS_AESCE_HAS_SUPPORT() (esp_mbedtls_aesce_has_support_result == -1 ? \
                                     esp_mbedtls_aesce_has_support_impl() : \
                                     esp_mbedtls_aesce_has_support_result)
