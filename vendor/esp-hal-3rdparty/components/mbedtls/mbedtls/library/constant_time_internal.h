 ...
 *   example: bool x = y | z          =>    x = esp_mbedtls_ct_bool_or(y, z)
 *   example: bool x = y == z         =>    x = esp_mbedtls_ct_uint_eq(y, z)
 *
 * - conditional data selection
 *   These are all named mbedtls_ct_<type>_if and mbedtls_ct_<type>_if_else_0
 *   All arguments are considered secret.
 *   example: size_t a = x ? b : c    =>    a = esp_mbedtls_ct_size_if(x, b, c)
 *   example: unsigned a = x ? b : 0  =>    a = esp_mbedtls_ct_uint_if_else_0(x, b)
 *
 * - block memory operations
 *   Only some arguments are considered secret, as documented for each
 *   function.
 *   example: if (x) memcpy(...)      =>    esp_mbedtls_ct_memcpy_if(x, ...)
 *
...
#define MBEDTLS_CT_TRUE  ((mbedtls_ct_condition_t) esp_mbedtls_ct_compiler_opaque(SIZE_MAX))
...
#define MBEDTLS_CT_TRUE  ((mbedtls_ct_condition_t) esp_mbedtls_ct_compiler_opaque(UINT64_MAX))
#else
...
#define MBEDTLS_CT_TRUE  ((mbedtls_ct_condition_t) esp_mbedtls_ct_compiler_opaque(UINT32_MAX))
#endif
#define MBEDTLS_CT_FALSE ((mbedtls_ct_condition_t) esp_mbedtls_ct_compiler_opaque(0))
 ...
 *
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_bool(mbedtls_ct_uint_t x);
 ...
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_uint_ne(mbedtls_ct_uint_t x, mbedtls_ct_uint_t y);
 ...
 * \return      MBEDTLS_CT_TRUE if \p x == \p y, otherwise MBEDTLS_CT_FALSE.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_uint_eq(mbedtls_ct_uint_t x,
                                                        mbedtls_ct_uint_t y);
 ...
 * \return      MBEDTLS_CT_TRUE if \p x < \p y, otherwise MBEDTLS_CT_FALSE.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_uint_lt(mbedtls_ct_uint_t x, mbedtls_ct_uint_t y);
 ...
 * \return      MBEDTLS_CT_TRUE if \p x > \p y, otherwise MBEDTLS_CT_FALSE.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_uint_gt(mbedtls_ct_uint_t x,
                                                        mbedtls_ct_uint_t y);
 ...
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_uint_ge(mbedtls_ct_uint_t x,
                                                        mbedtls_ct_uint_t y);
 ...
 *              otherwise MBEDTLS_CT_FALSE.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_uint_le(mbedtls_ct_uint_t x,
                                                        mbedtls_ct_uint_t y);
 ...
 * \param y     The second value to analyze.
 *
 * \note        This is more efficient than esp_mbedtls_ct_uint_ne if both arguments are
 *              mbedtls_ct_condition_t.
 *
 * \return      MBEDTLS_CT_TRUE if \p x != \p y,
 *              otherwise MBEDTLS_CT_FALSE.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_bool_ne(mbedtls_ct_condition_t x,
 ...
 *              otherwise MBEDTLS_CT_FALSE.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_bool_and(mbedtls_ct_condition_t x,
                                                         mbedtls_ct_condition_t y);
 ...
 *              otherwise MBEDTLS_CT_FALSE.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_bool_or(mbedtls_ct_condition_t x,
                                                        mbedtls_ct_condition_t y);
 ...
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_bool_not(mbedtls_ct_condition_t x);
 ...
 */
static inline size_t esp_mbedtls_ct_size_if(mbedtls_ct_condition_t condition,
                                        size_t if1,
                                        size_t if0);
 ...
 * \return  \c if1 if \p condition == MBEDTLS_CT_TRUE, otherwise \c if0.
 */
static inline unsigned esp_mbedtls_ct_uint_if(mbedtls_ct_condition_t condition,
                                          unsigned if1,
                                          unsigned if0);
 ...
 * \return  \c if1 if \p condition == MBEDTLS_CT_TRUE, otherwise \c if0.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_bool_if(mbedtls_ct_condition_t condition,
 ...
 * \return  \c if1 if \p condition == MBEDTLS_CT_TRUE, otherwise \c if0.
 */
static inline mbedtls_mpi_uint esp_mbedtls_ct_mpi_uint_if(mbedtls_ct_condition_t condition, \
 ...
 * condition ? if1 : 0.
 *
 * Functionally equivalent to esp_mbedtls_ct_uint_if(condition, if1, 0) but
 ...
 */
static inline unsigned esp_mbedtls_ct_uint_if_else_0(mbedtls_ct_condition_t condition, unsigned if1);
 ...
 * condition ? if1 : 0.
 *
 * Functionally equivalent to esp_mbedtls_ct_bool_if(condition, if1, 0) but
 * results in smaller code size.
 *
 * \param condition     Condition to test.
 * \param if1           Value to use if \p condition == MBEDTLS_CT_TRUE.
 ...
 * \return  \c if1 if \p condition == MBEDTLS_CT_TRUE, otherwise 0.
 */
static inline mbedtls_ct_condition_t esp_mbedtls_ct_bool_if_else_0(mbedtls_ct_condition_t condition,
                                                               mbedtls_ct_condition_t if1);
 ...
 * condition ? if1 : 0.
 *
 * Functionally equivalent to esp_mbedtls_ct_size_if(condition, if1, 0) but
 * results in smaller code size.
 *
 * \param condition     Condition to test.
 * \param if1           Value to use if \p condition == MBEDTLS_CT_TRUE.
 ...
 * \return  \c if1 if \p condition == MBEDTLS_CT_TRUE, otherwise 0.
 */
static inline size_t esp_mbedtls_ct_size_if_else_0(mbedtls_ct_condition_t condition, size_t if1);
 ...
 * condition ? if1 : 0.
 *
 * Functionally equivalent to esp_mbedtls_ct_mpi_uint_if(condition, if1, 0) but
 * results in smaller code size.
 *
 * \param condition     Condition to test.
 * \param if1           Value to use if \p condition == MBEDTLS_CT_TRUE.
 ...
 * \return  \c if1 if \p condition == MBEDTLS_CT_TRUE, otherwise 0.
 */
static inline mbedtls_mpi_uint esp_mbedtls_ct_mpi_uint_if_else_0(mbedtls_ct_condition_t condition,
                                                             mbedtls_mpi_uint if1);
 ...
 */
static inline unsigned char esp_mbedtls_ct_uchar_in_range_if(unsigned char low,
                                                         unsigned char high,
                                                         unsigned char c,
                                                         unsigned char t);
 ...
 * \return  \c if1 if \p condition == MBEDTLS_CT_TRUE, otherwise \c if0.
 */
static inline int esp_mbedtls_ct_error_if(mbedtls_ct_condition_t condition, int if1, int if0);
 ...
 * condition ? if1 : 0.
 *
 * Functionally equivalent to esp_mbedtls_ct_error_if(condition, if1, 0) but
 * results in smaller code size.
 *
 * \param condition     Condition to test.
 * \param if1           Value to use if \p condition == MBEDTLS_CT_TRUE.
 ...
 * \return  \c if1 if \p condition == MBEDTLS_CT_TRUE, otherwise 0.
 */
static inline int esp_mbedtls_ct_error_if_else_0(mbedtls_ct_condition_t condition, int if1);
 ...
 *
 * \warning Unlike esp_mbedtls_platform_zeroize, this does not have the same guarantees
 * about not being optimised away if the memory is never read again.
 */
void esp_mbedtls_ct_zeroize_if(mbedtls_ct_condition_t condition, void *buf, size_t len);
 ...
 */
void esp_mbedtls_ct_memmove_left(void *start,
                             size_t total,
                             size_t offset);
 ...
 */
void esp_mbedtls_ct_memcpy_if(mbedtls_ct_condition_t condition,
                          unsigned char *dest,
 ...
 */
void esp_mbedtls_ct_memcpy_offset(unsigned char *dest,
...
/* Documented in include/mbedtls/constant_time.h. a and b are secret.
   ...
   int esp_mbedtls_ct_memcmp(const void *a,
                         const void *b,
                         size_t n);
 */
 ...
 *
 * Similar to esp_mbedtls_ct_memcmp, except that the result only depends on part of
 ...
 */
int esp_mbedtls_ct_memcmp_partial(const void *a,
                              const void *b,
                              size_t n,
                              size_t skip_head,
                              size_t skip_tail);
