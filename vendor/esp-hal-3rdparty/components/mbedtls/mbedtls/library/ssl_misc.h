 ...
 *
 * \sa             esp_mbedtls_ssl_conf_max_frag_len()
                                          ...
                                          const uint8_t *end, size_t need)
{
    if ((cur > end) || (need > (size_t) (end - cur))) {
        esp_mbedtls_ssl_set_chk_buf_ptr_fail_args(cur, end, need);
        return 1;
    }
    return 0;
}
...
struct mbedtls_ssl_key_set {
    ...
    size_t esp_key_len; /*!< The length of client_write_key and
...
struct mbedtls_ssl_handshake_params {
    ...
    struct {
        size_t total_bytes_buffered; /*!< Cumulative size of esp_heap allocated
...
struct mbedtls_ssl_transform {
     ...
     * see esp_ssl_tls12_populate_transform() */
...
typedef struct {
    ...
    uint8_t ver[2];         /* SSL/TLS version as present on the wire.
                             ...
                             * using esp_mbedtls_ssl_read_version() and
                             * esp_mbedtls_ssl_write_version().
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls12_write_client_hello_exts(mbedtls_ssl_context *ssl,
                                              unsigned char *buf,
...
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_handshake_client_step(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
 ...
 *
 *              a Updating
 *                [Currently implemented by esp_mbedtls_ssl_read_record]
 *
 ...
 *              application data reading function esp_mbedtls_ssl_read.
 *
 * \note        The above tries to give a conceptual picture of the
 *              record layer, but the current implementation deviates
 *              from it in some places. For example, our implementation of
 *              the update functionality through esp_mbedtls_ssl_read_record
...
#if !defined(MBEDTLS_USE_PSA_CRYPTO)
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_psk_derive_premaster(mbedtls_ssl_context *ssl,
 ...
 * 1. handshake PSK set by \c esp_mbedtls_ssl_set_hs_psk_opaque() in the PSK
 *    callback
 ...
 * 1. handshake PSK set by \c esp_mbedtls_ssl_set_hs_psk() in the PSK callback
...
/* Alias of esp_mbedtls_ssl_pend_fatal_alert */
#define MBEDTLS_SSL_PEND_FATAL_ALERT(type, user_return_value)         \
    esp_mbedtls_ssl_pend_fatal_alert(ssl, type, user_return_value)
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_3)
extern const uint8_t esp_mbedtls_ssl_tls13_hello_retry_request_magic[
    MBEDTLS_SERVER_HELLO_RANDOM_LEN];
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_process_finished_message(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_write_finished_message(mbedtls_ssl_context *ssl);
void esp_mbedtls_ssl_tls13_handshake_wrapup(mbedtls_ssl_context *ssl);
 ...
 */
static inline int esp_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(mbedtls_ssl_context *ssl,
                                                             int kex_mode_mask)
{
    return (ssl->conf->tls13_kex_modes & kex_mode_mask) != 0;
}

static inline int esp_mbedtls_ssl_conf_tls13_is_psk_enabled(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
                                                      MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK);
}

static inline int esp_mbedtls_ssl_conf_tls13_is_psk_ephemeral_enabled(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
                                                      MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_EPHEMERAL);
}

static inline int esp_mbedtls_ssl_conf_tls13_is_ephemeral_enabled(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
                                                      MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL);
}

static inline int esp_mbedtls_ssl_conf_tls13_is_some_ephemeral_enabled(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
                                                      MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ALL);
}

static inline int esp_mbedtls_ssl_conf_tls13_is_some_psk_enabled(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_conf_tls13_is_kex_mode_enabled(ssl,
 ...
 */
static inline int esp_mbedtls_ssl_tls13_is_kex_mode_supported(mbedtls_ssl_context *ssl,
                                                          int kex_modes_mask)
{
    return (ssl->handshake->tls13_kex_modes & kex_modes_mask) != 0;
}

static inline int esp_mbedtls_ssl_tls13_is_psk_supported(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK);
}

static inline int esp_mbedtls_ssl_tls13_is_psk_ephemeral_supported(
    mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_EPHEMERAL);
...
static inline int esp_mbedtls_ssl_tls13_is_ephemeral_supported(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL);
}

static inline int esp_mbedtls_ssl_tls13_is_some_ephemeral_supported(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ALL);
}

static inline int esp_mbedtls_ssl_tls13_is_some_psk_supported(mbedtls_ssl_context *ssl)
{
    return esp_mbedtls_ssl_tls13_is_kex_mode_supported(ssl,
                                                   MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_ALL);
}
...
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_check_received_extension(
    mbedtls_ssl_context *ssl,
    int hs_msg_type,
    ...
    mbedtls_ssl_context *ssl, unsigned int extension_type)
{
    ssl->handshake->sent_extensions |=
        esp_mbedtls_ssl_get_extension_mask(extension_type);
}
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_fetch_handshake_msg(mbedtls_ssl_context *ssl,
                                          unsigned hs_type,
                                          unsigned char **buf,
                                          size_t *buf_len);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_is_supported_versions_ext_present_in_exts(
    mbedtls_ssl_context *ssl,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_process_certificate(mbedtls_ssl_context *ssl);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_write_certificate(mbedtls_ssl_context *ssl);

/*
 * Handler of TLS 1.3 write Certificate Verify message
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_write_certificate_verify(mbedtls_ssl_context *ssl);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_process_certificate_verify(mbedtls_ssl_context *ssl);

/*
 * Write of dummy-CCS's for middlebox compatibility
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_write_change_cipher_spec(mbedtls_ssl_context *ssl);

MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_reset_transcript_for_hrr(mbedtls_ssl_context *ssl);

#if defined(PSA_WANT_ALG_ECDH) || defined(PSA_WANT_ALG_FFDH)
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_generate_and_write_xxdh_key_exchange(
    mbedtls_ssl_context *ssl,
...
#if defined(MBEDTLS_SSL_EARLY_DATA)
int esp_mbedtls_ssl_tls13_write_early_data_ext(mbedtls_ssl_context *ssl,
                                           int in_new_session_ticket,
                                           unsigned char *buf,
                                           const unsigned char *end,
                                           size_t *out_len);

int esp_mbedtls_ssl_tls13_check_early_data_len(mbedtls_ssl_context *ssl,
 ...
 * when esp_mbedtls_ssl_conf_curves() is deleted.
 *
 * ssl->handshake->group_list is either a translation of curve_list to IANA TLS group
 * identifiers when esp_mbedtls_ssl_conf_curves() has been used, or a pointer to
...
static inline int esp_mbedtls_ssl_tls13_named_group_is_ffdh(uint16_t named_group)
{
...
static inline int esp_mbedtls_ssl_named_group_is_supported(uint16_t named_group)
{
    ...
    if (esp_mbedtls_ssl_tls13_named_group_is_ffdh(named_group)) {
        return 1;
    }
#endif
#if !defined(PSA_WANT_ALG_ECDH) && !defined(PSA_WANT_ALG_FFDH)
 ...
 * esp_mbedtls_ssl_conf_sig_hashes() is deleted.
 *
 * ssl->handshake->sig_algs is either a translation of sig_hashes to IANA TLS
 * signature algorithm identifiers when esp_mbedtls_ssl_conf_sig_hashes() has been
 * used, or a pointer to ssl->conf->sig_algs when esp_mbedtls_ssl_conf_sig_algs() has
...
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_check_sig_alg_cert_key_match(uint16_t sig_alg,
    ...
    uint16_t sig_alg, mbedtls_pk_type_t *pk_type, mbedtls_md_type_t *md_alg)
{
    ...
    *md_alg = esp_mbedtls_ssl_md_alg_from_hash((sig_alg >> 8) & 0xff);
...
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_read_public_xxdhe_share(mbedtls_ssl_context *ssl,
                                              const unsigned char *buf,
                                              size_t buf_len);
...
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_parse_record_size_limit_ext(mbedtls_ssl_context *ssl,
                                                  const unsigned char *buf,
                                                  const unsigned char *end);

MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_write_record_size_limit_ext(mbedtls_ssl_context *ssl,
                                                  unsigned char *buf,
                                                  const unsigned char *end,
                                                  size_t *out_len);
#endif /* MBEDTLS_SSL_RECORD_SIZE_LIMIT */
...
static inline unsigned int esp_mbedtls_ssl_tls13_session_get_ticket_flags(
 ...
 * permitted flags.
 */
static inline int esp_mbedtls_ssl_tls13_session_ticket_has_flags(
    mbedtls_ssl_session *session, unsigned int flags)
{
    return esp_mbedtls_ssl_tls13_session_get_ticket_flags(session, flags) != 0;
}

static inline int esp_mbedtls_ssl_tls13_session_ticket_allow_psk(
    mbedtls_ssl_session *session)
{
    return esp_mbedtls_ssl_tls13_session_ticket_has_flags(
        session, MBEDTLS_SSL_TLS1_3_TICKET_ALLOW_PSK_RESUMPTION);
}

static inline int esp_mbedtls_ssl_tls13_session_ticket_allow_psk_ephemeral(
    mbedtls_ssl_session *session)
{
    return esp_mbedtls_ssl_tls13_session_ticket_has_flags(
...
static inline unsigned int esp_mbedtls_ssl_tls13_session_ticket_allow_early_data(
    mbedtls_ssl_session *session)
{
    return esp_mbedtls_ssl_tls13_session_ticket_has_flags(
...
static inline void esp_mbedtls_ssl_tls13_session_set_ticket_flags(
    mbedtls_ssl_session *session, unsigned int flags)
{
    session->ticket_flags |= (flags & MBEDTLS_SSL_TLS1_3_TICKET_FLAGS_MASK);
}

static inline void esp_mbedtls_ssl_tls13_session_clear_ticket_flags(
    mbedtls_ssl_session *session, unsigned int flags)
{
    session->ticket_flags &= ~(flags & MBEDTLS_SSL_TLS1_3_TICKET_FLAGS_MASK);
}
 ...
 *                          with esp_mbedtls_md_hmac_starts() and use one of the
 *                          following hashes: SHA-384, SHA-256, SHA-1 or MD-5.
 *                          It is reset using esp_mbedtls_md_hmac_reset() after
