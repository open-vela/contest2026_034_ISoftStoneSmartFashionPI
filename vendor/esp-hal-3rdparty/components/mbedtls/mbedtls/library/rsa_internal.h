...
/**
 * \brief This function is analogue to \c esp_mbedtls_rsa_rsassa_pss_sign().
 *        The only difference between them is that this function is more flexible
 *        on the parameters of \p ctx that are set with \c esp_mbedtls_rsa_set_padding().
 *
 ...
 *
 * \note  Refer to \c esp_mbedtls_rsa_rsassa_pss_sign() for a description
