...
#endif
static inline uint16_t esp_mbedtls_get_unaligned_uint16(const void *p)
{
    uint16_t r;
...
__attribute__((always_inline))
#endif
static inline void esp_mbedtls_put_unaligned_uint16(void *p, uint16_t x)
{
#if defined(UINT_UNALIGNED)
    mbedtls_uint16_unaligned_t *p16 = (mbedtls_uint16_unaligned_t *) p;
    *p16 = x;
...
__attribute__((always_inline))
#endif
static inline uint32_t esp_mbedtls_get_unaligned_uint32(const void *p)
{
    uint32_t r;
#if defined(UINT_UNALIGNED)
...
__attribute__((always_inline))
#endif
static inline void esp_mbedtls_put_unaligned_uint32(void *p, uint32_t x)
{
#if defined(UINT_UNALIGNED)
    mbedtls_uint32_unaligned_t *p32 = (mbedtls_uint32_unaligned_t *) p;
    *p32 = x;
...
__attribute__((always_inline))
#endif
static inline uint64_t esp_mbedtls_get_unaligned_uint64(const void *p)
{
    uint64_t r;
#if defined(UINT_UNALIGNED)
...
__attribute__((always_inline))
#endif
static inline void esp_mbedtls_put_unaligned_uint64(void *p, uint64_t x)
{
#if defined(UINT_UNALIGNED)
    mbedtls_uint64_unaligned_t *p64 = (mbedtls_uint64_unaligned_t *) p;
    *p64 = x;
