...
extern const mbedtls_pk_info_t esp_mbedtls_rsa_info;
#endif

#if defined(MBEDTLS_PK_HAVE_ECC_KEYS)
extern const mbedtls_pk_info_t esp_mbedtls_eckey_info;
extern const mbedtls_pk_info_t esp_mbedtls_eckeydh_info;
#endif

#if defined(MBEDTLS_PK_CAN_ECDSA_SOME)
extern const mbedtls_pk_info_t esp_mbedtls_ecdsa_info;
#endif

#if defined(MBEDTLS_PK_RSA_ALT_SUPPORT)
extern const mbedtls_pk_info_t esp_mbedtls_rsa_alt_info;
#endif

#if defined(MBEDTLS_USE_PSA_CRYPTO)
extern const mbedtls_pk_info_t esp_mbedtls_ecdsa_opaque_info;
extern const mbedtls_pk_info_t esp_mbedtls_rsa_opaque_info;

#if defined(MBEDTLS_RSA_C)
int esp_mbedtls_pk_psa_rsa_sign_ext(psa_algorithm_t psa_alg_md,
