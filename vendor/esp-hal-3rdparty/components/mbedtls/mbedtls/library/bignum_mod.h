 ...
 *                  esp_mbedtls_mpi_mod_residue_release() is called. The data
 ...
 * esp_mbedtls_mpi_mod_residue_setup() to make it safe to free or use again.
 *
 * This function invalidates \p r and it must not be used until after
 * esp_mbedtls_mpi_mod_residue_setup() is called on it again.
 *
 ...
 *                  not be modified in any way until after
 *                  esp_mbedtls_mpi_mod_modulus_free() is called.
 ...
 *
 * This function frees any memory allocated by esp_mbedtls_mpi_mod_modulus_setup().
 *
 * \warning This function does not free the limb array passed to
 *          esp_mbedtls_mpi_mod_modulus_setup() only removes the reference to it,
 ...
 *       esp_mbedtls_mpi_mod_residue_setup().
 *
 ...
 * esp_mbedtls_mpi_mod_residue_setup() and esp_mbedtls_mpi_mod_read()).
 *
