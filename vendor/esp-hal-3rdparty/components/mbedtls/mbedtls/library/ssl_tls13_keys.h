...
extern const struct mbedtls_ssl_tls13_labels_struct esp_mbedtls_ssl_tls13_labels;

#define MBEDTLS_SSL_TLS1_3_LBL_LEN(LABEL)  \
    sizeof(esp_mbedtls_ssl_tls13_labels.LABEL)

#define MBEDTLS_SSL_TLS1_3_LBL_WITH_LEN(LABEL)  \
    esp_mbedtls_ssl_tls13_labels.LABEL,              \
 ...
 * esp_ssl_tls13_hkdf_encode_label() in ssl_tls13_keys.c needs to be
 ...
 * \param esp_key_len       The desired length of the key to be extracted in Bytes.
 ...
 *
 *        This is a small wrapper invoking esp_mbedtls_ssl_tls13_derive_secret()
 ...
 *        further processed by esp_mbedtls_ssl_tls13_make_traffic_keys().
 *
 ...
 *        esp_mbedtls_ssl_tls13_create_psk_binder().
 *
 ...
 * see e.g. esp_mbedtls_ssl_tls13_make_traffic_keys().
 *
 ...
 *                     been initialized through esp_mbedtls_ssl_transform_init() and
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
int esp_mbedtls_ssl_tls13_populate_transform(mbedtls_ssl_transform *transform,
                                         int endpoint,
                                         int ciphersuite,
 ...
 *
 * Small wrappers around esp_mbedtls_ssl_tls13_evolve_secret().
 */
 ...
 *             esp_mbedtls_ssl_tls13_key_schedule_stage_early() before to
