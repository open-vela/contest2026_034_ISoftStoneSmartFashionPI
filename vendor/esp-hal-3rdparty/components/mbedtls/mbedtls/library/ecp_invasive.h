...
mbedtls_ecp_variant esp_mbedtls_ecp_get_variant(void);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p192_raw(mbedtls_mpi_uint *Np, size_t Nn);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p224_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p256_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p521_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int  esp_mbedtls_ecp_mod_p384_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p192k1_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p224k1_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p256k1_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p255_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_mod_p448_raw(mbedtls_mpi_uint *X, size_t X_limbs);
 ...
 *                  esp_mbedtls_mpi_mod_modulus_free(&N) should be invoked at the
 ...
 */
MBEDTLS_STATIC_TESTABLE
int esp_mbedtls_ecp_modulus_setup(mbedtls_mpi_mod_modulus *N,
