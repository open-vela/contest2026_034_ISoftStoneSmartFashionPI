...
extern volatile mbedtls_ct_uint_t esp_mbedtls_ct_zero;
#endif
 ...
 *                 x = esp_mbedtls_ct_compiler_opaque(1), x will be unknown).
 *
 ...
 */
static inline mbedtls_ct_uint_t esp_mbedtls_ct_compiler_opaque(mbedtls_ct_uint_t x)
{
#if defined(MBEDTLS_CT_ASM)
    asm volatile ("" : [x] "+r" (x) :);
    return x;
#else
    return x ^ esp_mbedtls_ct_zero;
#endif
}
...
static inline mbedtls_ct_condition_t esp_mbedtls_ct_bool(mbedtls_ct_uint_t x)
{
    ...
    return (mbedtls_ct_condition_t) x;
#else
    const mbedtls_ct_uint_t xo = esp_mbedtls_ct_compiler_opaque(x);
#if defined(_MSC_VER)
...
static inline mbedtls_ct_uint_t esp_mbedtls_ct_if(mbedtls_ct_condition_t condition,
                                              ...
                                              mbedtls_ct_uint_t if0)
{
    ...
    mbedtls_ct_condition_t not_cond =
        (mbedtls_ct_condition_t) (~esp_mbedtls_ct_compiler_opaque(condition));
...
static inline mbedtls_ct_condition_t esp_mbedtls_ct_uint_lt(mbedtls_ct_uint_t x, mbedtls_ct_uint_t y)
{
     ...
     */
    const mbedtls_ct_uint_t xo = esp_mbedtls_ct_compiler_opaque(x);
    const mbedtls_ct_uint_t yo = esp_mbedtls_ct_compiler_opaque(y);
    /*
     * Check if the most significant bits (MSB) of the operands are different.
     * cond is true iff the MSBs differ.
     */
    mbedtls_ct_condition_t cond = esp_mbedtls_ct_bool((xo ^ yo) >> (MBEDTLS_CT_SIZE - 1));
...
static inline mbedtls_ct_condition_t esp_mbedtls_ct_uint_ne(mbedtls_ct_uint_t x, mbedtls_ct_uint_t y)
{
    ...
    const mbedtls_ct_uint_t diff = esp_mbedtls_ct_compiler_opaque(x) ^ esp_mbedtls_ct_compiler_opaque(y);

    /* all ones if x != y, 0 otherwise */
    return esp_mbedtls_ct_bool(diff);
}
...
static inline unsigned char esp_mbedtls_ct_uchar_in_range_if(unsigned char low,
                                                         ...
                                                         unsigned char t)
{
    const unsigned char co = (unsigned char) esp_mbedtls_ct_compiler_opaque(c);
    const unsigned char to = (unsigned char) esp_mbedtls_ct_compiler_opaque(t);
...
static inline size_t esp_mbedtls_ct_size_if(mbedtls_ct_condition_t condition,
                                        ...
                                        size_t if0)
{
    return (size_t) esp_mbedtls_ct_if(condition, (mbedtls_ct_uint_t) if1, (mbedtls_ct_uint_t) if0);
}
...
static inline unsigned esp_mbedtls_ct_uint_if(mbedtls_ct_condition_t condition,
                                          ...
                                          unsigned if0)
{
    return (unsigned) esp_mbedtls_ct_if(condition, (mbedtls_ct_uint_t) if1, (mbedtls_ct_uint_t) if0);
}
...
{
    return (mbedtls_ct_condition_t) esp_mbedtls_ct_if(condition, (mbedtls_ct_uint_t) if1,
                                                  (mbedtls_ct_uint_t) if0);
}
...
{
    return (mbedtls_mpi_uint) esp_mbedtls_ct_if(condition,
                                            (mbedtls_ct_uint_t) if1,
                                            (mbedtls_ct_uint_t) if0);
}
...
static inline int esp_mbedtls_ct_error_if(mbedtls_ct_condition_t condition, int if1, int if0)
{
     ...
     */
    return -((int) esp_mbedtls_ct_if(condition, (mbedtls_ct_uint_t) (-if1),
                                 (mbedtls_ct_uint_t) (-if0)));
}
