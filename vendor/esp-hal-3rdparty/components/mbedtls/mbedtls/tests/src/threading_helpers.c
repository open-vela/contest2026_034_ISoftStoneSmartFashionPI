...
enum value_of_mutex_state_field {
     ...
     * compatibility with esp_threading_mutex_init_pthread() and
     * esp_threading_mutex_free_pthread(). MUTEX_LOCKED could be any nonzero
     * value. */
...
/**
 *  The total number of calls to esp_mbedtls_mutex_init(), minus the total number
 *  of calls to esp_mbedtls_mutex_free().
 *
                                           ...
                                           const char *msg)
{
    ...
    esp_mbedtls_fprintf(stdout, "[mutex: %s] ", msg);
...
{
    mutex_functions.init = esp_mbedtls_mutex_init;
    mutex_functions.free = esp_mbedtls_mutex_free;
    mutex_functions.lock = esp_mbedtls_mutex_lock;
    mutex_functions.unlock = esp_mbedtls_mutex_unlock;
    esp_mbedtls_mutex_init = &mbedtls_test_wrap_mutex_init;
    esp_mbedtls_mutex_free = &mbedtls_test_wrap_mutex_free;
    esp_mbedtls_mutex_lock = &mbedtls_test_wrap_mutex_lock;
    esp_mbedtls_mutex_unlock = &mbedtls_test_wrap_mutex_unlock;
...
void mbedtls_test_mutex_usage_check(void)
{
    if (mutex_functions.lock(&mbedtls_test_mutex_mutex) == 0) {
        if (live_mutexes != 0) {
            ...
            esp_mbedtls_fprintf(stdout, "[mutex: %d leaked] ", live_mutexes);
            live_mutexes = 0;
...
{
    esp_mbedtls_mutex_init = mutex_functions.init;
    esp_mbedtls_mutex_free = mutex_functions.free;
    esp_mbedtls_mutex_lock = mutex_functions.lock;
    esp_mbedtls_mutex_unlock = mutex_functions.unlock;
