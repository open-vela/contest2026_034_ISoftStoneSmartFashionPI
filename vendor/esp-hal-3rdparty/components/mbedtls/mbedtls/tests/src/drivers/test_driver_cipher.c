    ...
    size_t *output_length)
{
    ...
    return esp_mbedtls_psa_cipher_encrypt(
    ...
    size_t *output_length)
{
    ...
    return libtestdriver1_mbedtls_psa_cipher_decrypt(
        ...
        output, output_size, output_length);
#elif defined(MBEDTLS_PSA_BUILTIN_CIPHER)
    return esp_mbedtls_psa_cipher_decrypt(
        attributes, key_buffer, key_buffer_size,
        alg, input, input_length,
        output, output_size, output_length);
#endif
    ...
    psa_algorithm_t alg)
{
    ...
    return libtestdriver1_mbedtls_psa_cipher_encrypt_setup(
        ...
        key, key_length, alg);
#elif defined(MBEDTLS_PSA_BUILTIN_CIPHER)
    return esp_mbedtls_psa_cipher_encrypt_setup(
    ...
    psa_algorithm_t alg)
{
    ...
    return libtestdriver1_mbedtls_psa_cipher_decrypt_setup(
        ...
        key, key_length, alg);
#elif defined(MBEDTLS_PSA_BUILTIN_CIPHER)
    return esp_mbedtls_psa_cipher_decrypt_setup(
        operation, attributes, key, key_length, alg);
#endif
...
#elif defined(MBEDTLS_PSA_BUILTIN_CIPHER)
    return esp_mbedtls_psa_cipher_set_iv(operation, iv, iv_length);
#endif
    ...
    size_t *output_length)
{
    ...
    return libtestdriver1_mbedtls_psa_cipher_update(
        ...
        output, output_size, output_length);
#elif defined(MBEDTLS_PSA_BUILTIN_CIPHER)
    return esp_mbedtls_psa_cipher_update(
        operation, input, input_length,
        output, output_size, output_length);
#endif
...
#elif defined(MBEDTLS_PSA_BUILTIN_CIPHER)
    return esp_mbedtls_psa_cipher_finish(
        operation, output, output_size, output_length);
#endif
