...
#define PSA_INIT() PSA_ASSERT(esp_psa_crypto_init())
 ...
 * ```
 * #define esp_psa_crypto_init() RECORD_STATUS("esp_psa_crypto_init", esp_psa_crypto_init())
 * ```
