...
int main(void)
{
    ...
    esp_mbedtls_printf("PSA_CRYPTO_PLATFORM_H\n");
#endif
#if defined(PSA_CRYPTO_PLATFORM_ALT_H)
    esp_mbedtls_printf("PSA_CRYPTO_PLATFORM_ALT_H\n");
#endif

    /* Which PSA struct header? */
#if defined(PSA_CRYPTO_STRUCT_H)
    esp_mbedtls_printf("PSA_CRYPTO_STRUCT_H\n");
#endif
#if defined(PSA_CRYPTO_STRUCT_ALT_H)
    esp_mbedtls_printf("PSA_CRYPTO_STRUCT_ALT_H\n");
#endif
