...
extern mbedtls_time_t (*esp_mbedtls_time)(mbedtls_time_t *time);
 ...
 * \return              0
 */
int esp_mbedtls_platform_set_time(mbedtls_time_t (*time_func)(mbedtls_time_t *time));
#else
#if defined(MBEDTLS_PLATFORM_TIME_MACRO)
#define esp_mbedtls_time    MBEDTLS_PLATFORM_TIME_MACRO
#else
