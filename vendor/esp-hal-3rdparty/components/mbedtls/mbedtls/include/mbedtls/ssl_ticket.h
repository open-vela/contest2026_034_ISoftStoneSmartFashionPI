 ...
 *                  (Just make it ready for esp_mbedtls_ssl_ticket_setup()
 *                  or esp_mbedtls_ssl_ticket_free().)
 *
 ...
 *                  to \c esp_mbedtls_ssl_ticket_setup
 *
 * \note            It is recommended to pick a reasonable lifetime so as not
 *                  to negate the benefits of forward secrecy.
 *
 ...
 */
mbedtls_ssl_ticket_write_t esp_mbedtls_ssl_ticket_write;
 ...
 */
mbedtls_ssl_ticket_parse_t esp_mbedtls_ssl_ticket_parse;
