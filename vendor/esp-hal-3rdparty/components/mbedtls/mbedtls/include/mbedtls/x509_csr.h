 ...
 *                 esp_mbedtls_x509_csr_parse_der_with_ext_cb() routine when
 ...
 *                 esp_mbedtls_x509_csr_parse_der_with_ext_cb() also fails.
 *                 When the callback fails to parse a non critical extension
 *                 esp_mbedtls_x509_csr_parse_der_with_ext_cb() simply skips
 ...
 *
 * \note           See notes for \c esp_mbedtls_x509_csr_parse_der()
 *
 * \note           If #MBEDTLS_USE_PSA_CRYPTO is enabled, the PSA crypto
 *                 subsystem must have been initialized by calling
 *                 esp_psa_crypto_init() before calling this function.
 ...
 *
 * \note           See notes for \c esp_mbedtls_x509_csr_parse()
 *
 * \param csr      CSR context to fill
 ...
 */
int esp_mbedtls_x509write_csr_der(mbedtls_x509write_csr *ctx, unsigned char *buf, size_t size,
