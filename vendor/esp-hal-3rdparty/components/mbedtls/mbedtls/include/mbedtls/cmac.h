 ...
 *                      esp_mbedtls_cipher_cmac_update().
 *
 *                      To start a CMAC computation using the same key as a previous
 *                      CMAC computation, use esp_mbedtls_cipher_cmac_finish().
 *
 ...
 *                      by calling esp_mbedtls_cipher_cmac_starts() or
 *                      esp_mbedtls_cipher_cmac_reset().
 *
 *                      Call this function as many times as needed to input the
 *                      data to be authenticated.
 *                      Once all of the required data has been input,
 *                      call esp_mbedtls_cipher_cmac_finish() to obtain the result
 ...
 *                      esp_mbedtls_cipher_cmac_reset(), which starts another CMAC
 *                      operation with the same key, or esp_mbedtls_cipher_free(),
 ...
 *                      operation with esp_mbedtls_cipher_cmac_finish().
 *                      After calling this function,
 *                      call esp_mbedtls_cipher_cmac_update() to supply the new
 ...
 * \param esp_key_len   The key length in Bytes.
 * \param input     The buffer holding the input data.
 ...
 * \return          \c 0 on success.
 */
int esp_mbedtls_aes_cmac_prf_128(const unsigned char *key, size_t esp_key_len,
