 ...
 * \{
 */
/* Reminder: update esp_x509_crt_verify_strings[] in library/x509_crt.c */
 ...
 * Reminder: update esp_mbedtls_x509_info_key_usage() when adding new flags.
 */
 ...
 *                   call to esp_mbedtls_asn1_free_named_data_list().
 *
 ...
 */
static inline mbedtls_x509_name *esp_mbedtls_x509_dn_get_next(
 ...
 *                 > 0 if t1 is after t2
 */
int esp_mbedtls_x509_time_cmp(const mbedtls_x509_time *t1, const mbedtls_x509_time *t2);
 ...
 *                 esp_mbedtls_x509_free_subject_alt_name has to be called
