 ...
 * See the documentation of esp_mbedtls_ctr_drbg_seed() for more
 * information.
 */
/*
 ...
 * to include a nonce.
 * See the documentation of esp_mbedtls_ctr_drbg_seed() for more information.
 */
...
typedef struct mbedtls_ctr_drbg_context {
    ...
    int MBEDTLS_PRIVATE(reseed_counter);         /*!< The reseed counter.
                                                  ...
                                                  * set (see esp_mbedtls_ctr_drbg_set_nonce_len()).
                                                  */
     ...
     * in esp_mbedtls_ctr_drbg_seed() and freed in esp_mbedtls_ctr_drbg_free().
     *
 ...
 *                      and prepares it for esp_mbedtls_ctr_drbg_seed()
 *                      or esp_mbedtls_ctr_drbg_free().
 *
 * \note                The reseed interval is
 *                      #MBEDTLS_CTR_DRBG_RESEED_INTERVAL by default.
 *                      You can override it by calling
 *                      esp_mbedtls_ctr_drbg_set_reseed_interval().
 *
 ...
 * - \p f_entropy is esp_mbedtls_entropy_func();
 * - \p p_entropy is an instance of ::mbedtls_entropy_context initialized
 *   with esp_mbedtls_entropy_init() (which registers the platform's default
 *   entropy sources).
 *
 * The entropy length is #MBEDTLS_CTR_DRBG_ENTROPY_LEN by default.
 * You can override it by calling esp_mbedtls_ctr_drbg_set_entropy_len().
 *
 ...
 * You can override it by calling esp_mbedtls_ctr_drbg_set_nonce_len().
...
/**
 * - If esp_mbedtls_ctr_drbg_set_nonce_len() has been called, a string
 ...
 *                      it is safe to call esp_mbedtls_ctr_drbg_random()
 ...
 *                      esp_mbedtls_ctr_drbg_init().
 *                      After a successful call to esp_mbedtls_ctr_drbg_seed(),
 *                      you may not call esp_mbedtls_ctr_drbg_seed() again on
 *                      the same context unless you call
 *                      esp_mbedtls_ctr_drbg_free() and esp_mbedtls_ctr_drbg_init()
 *                      again first.
 *                      After a failed call to esp_mbedtls_ctr_drbg_seed(),
 *                      you must call esp_mbedtls_ctr_drbg_free().
 ...
 *                      every call to esp_mbedtls_ctr_drbg_random_with_add()
 *                      or esp_mbedtls_ctr_drbg_random().
 ...
 *
 * Call this function before calling esp_mbedtls_ctr_drbg_seed() to read
 ...
 *
 * The reseed interval is the number of calls to esp_mbedtls_ctr_drbg_random()
 * or esp_mbedtls_ctr_drbg_random_with_add() after which the entropy function
 * is called again.
 *
 ...
 *                      #MBEDTLS_ERR_CTR_DRBG_REQUEST_TOO_BIG on failure.
 */
int esp_mbedtls_ctr_drbg_random(void *p_rng,
                            unsigned char *output, size_t output_len);
