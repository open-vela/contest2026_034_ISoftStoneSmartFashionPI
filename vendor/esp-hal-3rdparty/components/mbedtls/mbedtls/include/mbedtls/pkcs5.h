 ...
 *                 Please use esp_mbedtls_pkcs5_pbes2_ext() instead.
 *
 ...
 */
int MBEDTLS_DEPRECATED esp_mbedtls_pkcs5_pbes2(const mbedtls_asn1_buf *pbe_params, int mode,
 ...
 * \returns        0 on success, or a MBEDTLS_ERR_XXX code if verification fails.
 */
int esp_mbedtls_pkcs5_pbkdf2_hmac_ext(mbedtls_md_type_t md_type,
 ...
 *
 * \deprecated     Superseded by esp_mbedtls_pkcs5_pbkdf2_hmac_ext().
 *
 ...
 * \returns        0 on success, or a MBEDTLS_ERR_XXX code if verification fails.
 */
int MBEDTLS_DEPRECATED esp_mbedtls_pkcs5_pbkdf2_hmac(mbedtls_md_context_t *ctx,
                                                 const unsigned char *password,
                                                 size_t plen,
