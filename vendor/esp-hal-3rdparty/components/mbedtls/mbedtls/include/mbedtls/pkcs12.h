 ...
 *                   for cipher-based and esp_mbedtls_md-based PBE's
 *
 ...
 *                   Please use esp_mbedtls_pkcs12_pbe_ext() instead.
 *
 ...
 * \param md_type    the esp_mbedtls_md used
 ...
 */
int MBEDTLS_DEPRECATED esp_mbedtls_pkcs12_pbe(mbedtls_asn1_buf *pbe_params, int mode,
 ...
 * \param esp_mbedtls_md esp_mbedtls_md type to use during the derivation
...
int esp_mbedtls_pkcs12_derivation(unsigned char *data, size_t datalen,
                              ...
                              mbedtls_md_type_t esp_mbedtls_md, int id, int iterations);
