 ...
 *                  for esp_mbedtls_nist_kw_setkey() or esp_mbedtls_nist_kw_free().
 *
 ...
 * \return          cipher-specific error code on failure of the underlying cipher.
 */
int esp_mbedtls_nist_kw_wrap(mbedtls_nist_kw_context *ctx, mbedtls_nist_kw_mode_t mode,
 ...
 * \return          cipher-specific error code on failure of the underlying cipher.
 */
int esp_mbedtls_nist_kw_unwrap(mbedtls_nist_kw_context *ctx, mbedtls_nist_kw_mode_t mode,
                           const unsigned char *input, size_t in_len,
                           unsigned char *output, size_t *out_len, size_t out_size);
