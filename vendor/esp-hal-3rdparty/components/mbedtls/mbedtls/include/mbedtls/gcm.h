 ...
 *                  for esp_mbedtls_gcm_setkey() or esp_mbedtls_gcm_free().
 *
 *                  The function does not bind the GCM context to a particular
 *                  cipher, nor set the key. For this purpose, use
 *                  esp_mbedtls_gcm_setkey().
 *
 ...
 *                  only. For decryption, use esp_mbedtls_gcm_auth_decrypt() instead.
 *
 ...
 *                    you should use esp_mbedtls_gcm_auth_decrypt() instead of
