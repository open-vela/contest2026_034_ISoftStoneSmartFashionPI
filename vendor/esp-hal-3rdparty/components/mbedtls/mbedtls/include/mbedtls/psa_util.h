 ...
 *       This means that you must call esp_psa_crypto_init() before any call to
 ...
 * in esp_mbedtls_psa_get_random(), but it's kept for interface's backward
 * compatibility.
 */
 ...
 */
static inline psa_algorithm_t esp_mbedtls_md_psa_alg_from_type(mbedtls_md_type_t md_type)
{
 ...
 *                  regardless of whether it is supported or not.
 */
static inline mbedtls_md_type_t esp_mbedtls_md_type_from_psa_alg(psa_algorithm_t psa_alg)
{
