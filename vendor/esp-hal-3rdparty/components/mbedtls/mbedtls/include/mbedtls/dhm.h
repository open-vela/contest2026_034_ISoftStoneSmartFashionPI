...
/** Which parameter to access in esp_mbedtls_dhm_get_value(). */
typedef enum {
...
typedef struct mbedtls_dhm_context {
    ...
    mbedtls_mpi MBEDTLS_PRIVATE(esp_K);      /*!<  The shared secret = \c G^(XY) mod \c P. */
 ...
 *                 esp_mbedtls_dhm_set_group() below in conjunction with
 *                 esp_mbedtls_mpi_read_binary() and esp_mbedtls_mpi_read_string().
 *
 ...
 *                 esp_mbedtls_mpi_size() to computing the byte-size of an MPI.
 ...
 *                 in preparation for esp_mbedtls_dhm_make_params().
 *
 ...
 *                 its DHM parameters set, e.g. via esp_mbedtls_dhm_set_group().
 ...
 *   of esp_pi (for RFC 5236) or e (for RFC 7919) to this intermediate bit-string
