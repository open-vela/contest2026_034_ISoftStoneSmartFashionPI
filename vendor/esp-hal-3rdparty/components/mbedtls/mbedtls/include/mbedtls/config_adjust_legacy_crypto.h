 ...
 *   these esp_features are not supported in PSA so the only way to have them is
...
/* psa_util file esp_features some ECDSA conversion functions, to convert between
