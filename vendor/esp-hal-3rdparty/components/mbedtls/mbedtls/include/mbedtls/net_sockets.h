...
#define MBEDTLS_NET_POLL_READ  1 /**< Used in \c esp_mbedtls_net_poll to check for pending data  */
#define MBEDTLS_NET_POLL_WRITE 2 /**< Used in \c esp_mbedtls_net_poll to check if write possible */
