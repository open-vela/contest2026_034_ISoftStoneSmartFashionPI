 ...
 *                 `esp_mbedtls_ecp_curve_info_from_grp_id` or
 *                 `esp_mbedtls_ecp_group_load` on the extracted `group_id`.
 *
 ...
 *                  computation is performed by esp_mbedtls_ecdh_compute_shared().
 *
 * \see             ecp.h
 *
 * \param grp       The ECP group to use. This must be initialized and have
 *                  domain parameters loaded, for example through
 *                  mbedtls_ecp_load() or esp_mbedtls_ecp_tls_read_group().
 ...
 *                  computation is performed by esp_mbedtls_ecdh_gen_public().
 *
 * \see             ecp.h
 *
 * \note            If \p f_rng is not NULL, it is used to implement
 *                  countermeasures against side-channel attacks.
 *                  For more information, see esp_mbedtls_ecp_mul().
 *
 * \param grp       The ECP group to use. This must be initialized and have
 *                  domain parameters loaded, for example through
 *                  mbedtls_ecp_load() or esp_mbedtls_ecp_tls_read_group().
 ...
 *                  given.
 *
 *                  This function should be called after esp_mbedtls_ecdh_init() but
 *                  before esp_mbedtls_ecdh_make_params(). There is no need to call
 *                  this function before esp_mbedtls_ecdh_read_params().
 *
 ...
 * \return          \c 0 on success.
 */
int esp_mbedtls_ecdh_setup(mbedtls_ecdh_context *ctx,
 ...
 *                  ciphersuites. (It is called after esp_mbedtls_ecdh_setup().)
 *
 * \see             ecp.h
 *
 * \param ctx       The ECDH context to use. This must be initialized
 *                  and bound to a group, for example via esp_mbedtls_ecdh_setup().
 ...
 *              ciphersuites. (It is called after esp_mbedtls_ecdh_setup() and
 *              esp_mbedtls_ecdh_make_params().)
 *
 * \see         ecp.h
 *
 * \param ctx   The ECDH context to use. This must be initialized
 ...
 *
 * \see             \c esp_mbedtls_ecp_set_max_ops()
 *
