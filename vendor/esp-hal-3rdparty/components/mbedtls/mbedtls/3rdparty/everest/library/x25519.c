...
{
    esp_mbedtls_platform_zeroize( ctx, sizeof( mbedtls_x25519_context ) );
}
...
void mbedtls_x25519_free( mbedtls_x25519_context *ctx )
{
    ...
    esp_mbedtls_platform_zeroize( ctx->our_secret, MBEDTLS_X25519_KEY_SIZE_BYTES );
    esp_mbedtls_platform_zeroize( ctx->peer_point, MBEDTLS_X25519_KEY_SIZE_BYTES );
}
                               ...
                               mbedtls_x25519_ecdh_side side )
{
    ...
    case MBEDTLS_X25519_ECDH_THEIRS:
        return esp_mbedtls_ecp_point_write_binary( &key->grp, &key->Q, MBEDTLS_ECP_PF_COMPRESSED, &olen, ctx->peer_point, MBEDTLS_X25519_KEY_SIZE_BYTES );
    case MBEDTLS_X25519_ECDH_OURS:
        return esp_mbedtls_mpi_write_binary_le( &key->d, ctx->our_secret, MBEDTLS_X25519_KEY_SIZE_BYTES );
    default:
        return( MBEDTLS_ERR_ECP_BAD_INPUT_DATA );
    }
}
