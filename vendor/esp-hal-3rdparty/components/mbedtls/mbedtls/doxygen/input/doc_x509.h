 ...
 * of certificates.
 * In summary:
 *   - X.509 certificate (CRT) reading (see \c esp_mbedtls_x509_crt_parse(),
 *     \c esp_mbedtls_x509_crt_parse_der(), \c esp_mbedtls_x509_crt_parse_file()).
 *   - X.509 certificate revocation list (CRL) reading (see
 *     \c esp_mbedtls_x509_crl_parse(), \c esp_mbedtls_x509_crl_parse_der(),
 *     and \c esp_mbedtls_x509_crl_parse_file()).
 *   - X.509 certificate signature verification (see \c
 *     esp_mbedtls_x509_crt_verify() and \c esp_mbedtls_x509_crt_verify_with_profile().
 *   - X.509 certificate writing and certificate request writing (see
 *     \c esp_mbedtls_x509write_crt_der() and \c esp_mbedtls_x509write_csr_der()).
 *
