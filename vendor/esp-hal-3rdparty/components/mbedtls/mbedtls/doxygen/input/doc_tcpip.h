 ...
 * - listening on a port (see \c esp_mbedtls_net_bind()).
 * - accepting a connection (through \c esp_mbedtls_net_accept()).
 * - read/write (through \c esp_mbedtls_net_recv()/\c esp_mbedtls_net_send()).
 * - close a connection (through \c esp_mbedtls_net_close()).
 *
